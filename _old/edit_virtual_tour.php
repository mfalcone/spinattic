...
// ]]>
        ...
        <div class="wrapper wrapper-user wrapper-edit-tour">
...
<?php //If published, check if there is a newer version of this tour in draft
	...
	if($draft_subscript != '_draft' && $id != ''){
		...
		$ssqlp_draft = "SELECT id FROM tours_draft where date > '".$row["date"]."' and iduser = '".$_SESSION["usr"]."' and id = ".$id;
		//echo $ssqlp_draft ;
...
<?}?>
                  ...
                  <!--div id="tabs-2" class="tabs-content tab-user-interaction">
					...
					<label>
                        <input class="info-tour border-radius-4 form-user" type="checkbox" name="allow_comments" checked="checked">
                        Allow Comments
                    </label>
					<label>
                        <input class="info-tour border-radius-4 form-user" type="checkbox" name="allow_social" checked="checked">
                        Allow Social Sharing
                    </label>
					<label>
                        <input class="info-tour border-radius-4 form-user" type="checkbox" name="allow_embed" checked="checked">
                        Allow Embed Code
                    </label>
					<label>
                        <input class="info-tour border-radius-4 form-user" type="checkbox" name="allow_votes" checked="checked">
                        Allow Users votes
                    </label>
