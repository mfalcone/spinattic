	...
	$.fn.cSButtons = function(options)
	{
		...
		{	
			...
			$(this).on('click tap', function()
			{
				...
				popupWindow = window.open(shareUrl,'popUpWindow' + type,'height=' + popupHeight + ',width=' + popupWidth + ',left=' + left + ',top=' + top + ',resizable=yes,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no,status=yes');
			});
		});
	};
})(jQuery);