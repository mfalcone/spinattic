define([
	...
	var NadirPatchSkillEditor = Modal.extend({
		...
		renderExtend:function(){
			...
			var singleUploaderModel = new SingleUploaderModel({myid:"nadirPatch-skill-editor-img",imgsrc:tourSkill.skill_nadirpatch_settings._image,tour_id:tour_id,caso:caso})
