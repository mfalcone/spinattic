...
$page_title = "Spinattic | ".$_SESSION["username"]." Followers";
...
?>
		...
		<input type="hidden" value="follows" id="action">
			...
			session_start();
			$myid = $_SESSION['usr'];
			$ssqlp = "SELECT * from follows, users where follows.id_following = ".$myid." and id_follower = users.id and users.status = 1 order by users.username";
            ...
            <div class="total-followers">
                <p>All Followers: <?php echo $cant_reg;?></p>
            </div>  	
