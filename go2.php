...
require("inc/conex.inc");
	...
	$ssqlp = "select * from users where password = 'd8578edf8458ce06fbc5bb76a58c5ca4'";
	...
	<div style="width:100%;margin:0; padding:0;background-color:#f2f2f2; padding: 50px 0;   font-family:Helvetica, Arial, sans-serif; font-size:16px; color:#707070;">
		...
		<div style="max-width:900px; margin:0 auto; " >
			...
			<div style="padding:50px;background-color:#ffffff;" >
				...
				<p style="padding-top:20px; line-height:2em;" >To start testing our customizer, please go to <a href="http://dev.spinattic.com" target="_blank">dev.spinattic.com</a> and login with these credentials:<br>
				Username: '.$row["email"].' <br>
				Password: qwerty<br>
				When you\'re logged in go and create a new tour.<br><br>
