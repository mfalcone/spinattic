		    ...
		    <div class="login-register" <?if ($logged == 1){echo 'style="display:none"';}?>>
				...
				<?if ($logged == 1){?>
	                <li>
	                  ...
	                  <ul class="submenu">
	                    <li>
	                          <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/home">Home 
	                          ...
	                          <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/<?php echo $_SESSION["friendly_url"];?>?followers">followers 
	                          ...
	                          <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/<?php echo $_SESSION["friendly_url"];?>?following">following 
								<?
								session_start();
	                ...
	                <li>
	                  ...
	                  <ul class="submenu">
	                    <li>
	                          <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/customizer" target="_blank">create new tour <span class="newtourbt"></span></a>
	                          
	                          <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/tours">
	                          	Manage tours
	                          	<?php
	                          ...
	                          <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/panos">
	                          	Manage pano files
	                          	<?php
	                ...
	                <li>
	                  ...
	                  <ul class="submenu">
	                    <li>
	                    	  <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/edit_images.php">manage images</a>
	                    		
	                          <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/edit_post.php">create new post</a>
	                          
	                          <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/manager_posts.php">Manage posts</a>
	                          
	                          <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/edit_static_page.php">create new page</a>

	                          <a href="http://<?php echo $_SERVER[HTTP_HOST];?>/manager_pages.php">Manage pages</a>
	...
	<?}?>
	            ...
	            <div class="recommends">
	            	...
	            	<ul>
	            		...
	            		<?php if($logged == 1){?>
	            		<li>
	            			<a href="http://www.spinattic.com/blog-single-post.php?id=22" target="_blank">
	            				<img src="http://<?php echo $_SERVER[HTTP_HOST];?>/images/recommend/spinattic10.jpg" alt="GeoPress">
	            			</a>
	            		</li>
	            		<?php }?>	            		
	            	</ul>
