					...
					<h3>Skin Settings:</h3>
						...
						<div class="image-resizer">
							<label>Thumbnails size:
								<input type="number" max="232" min="50" step="any" id="image-width" />
								<input type="number" max="116" min="25" step="any" id="image-height" />
								px
							</label>
							<label>
								Margins:
								<input type="number" max="50" min="2" id="margins" />
							</label>
							<div class="image-wrapper">
								<img src="panos/thumb200x100.jpg" />
							</div>
						</div>
