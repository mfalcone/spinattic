...
function addMarker(id, lat, lng, username, user_pic, img, desc, views, likes, comments, opened)
{
	contentString = 
	     '<link rel="stylesheet" type="text/css" media="screen" href="../css/infomap.css" />'
        +'<div class="content-info-map">'
	    +'  <a href="tour.php?id='+id+'" class="thumb_map"><img src="'+img+'"></a>'
	    +'  <a href="#" class="user">'
	    ...
	    +'  	<a href="javascript:void(0)" id="like" class="likes">'+likes+'</a>'
	    +'  	<br clear="all">'
	    +'  </div>'
