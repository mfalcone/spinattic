...
<script src="<?echo "http://".$_SERVER[HTTP_HOST]."/";?>js/core.manager-panoramas.js"></script>
        <div class="wrapper wrapper-manager_posts">
			...
			<ul>
<?
		$ssqlp = "SELECT *, DATE_FORMAT(date,'%b %d %Y %h:%i %p') as fecha FROM blog ORDER BY date desc";
					...
					<li class="pano-item pano-item-manager">
						...
						<div class="loader-item">
	                    	<h3><?php echo $row["title"];?></h3>
		          			...
		          			<ul class="actions">
		          				<li><a href="edit_post.php?id=<?php echo $row["id"];?>">Edit</a></li>
		          				<li><a href="#" data-id="<?php echo $row["id"];?>" class="remove-blog-post">Delete</a></li>
		          				<li><a href="blog-single-post.php?id=<?php echo $row["id"];?>" >View</a></li>
		          			</ul>
		                </div>
	                    <br clear="all">
	   	                <a href="#" data-id="<?php echo $row["id"];?>" title="Delete post" class="delete-item remove-blog-post"></a>
	                </li>
