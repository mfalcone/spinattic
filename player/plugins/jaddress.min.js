...
function() {
    ...
    function(a, b) {
        ...
        e.encodeReserved = s("reserved", "encode"), e.parse = function(a, b) {
            ...
            for (var chunk, c, d, f, g = {}, h = a.split("&"), i = h.length, j = 0; i > j; j++) 
            	
            	c = h[j], d = "", f = "";

            
            	//alert('j: ' + j + ' - c: ' + c + ' - b: ' + b + ' - a: ' + a);
            	chunk = c.split("=");
                ...
                case 'atv':
                    ...
                    break;                	
                default:
                	 g.startscene = chunk[0]
            	}
            
            	console.log('start: ' + g.startscene);
            ...
            //console.log('a.fragment: ' + a.fragment);
