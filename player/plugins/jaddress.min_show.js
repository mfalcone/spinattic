...
function() {
    ...
    function(a, b) {
        ...
        e.encodeReserved = s("reserved", "encode"), e.parse = function(a, b) {
            ...
            console.log('fov: ' + g.fov);
            console.log('atv: ' + g.atv);
            console.log('ath: ' + g.ath);
            console.log('startscene: ' + g.startscene);
